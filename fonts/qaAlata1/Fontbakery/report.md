...
<details>
<summary><b>[8] Alata-Regular.ttf</b></summary>
<details>
...
"Copyright (c) 2011-2018, Sorkin Type Co (www.sorkintype.com) with Reserved Font Name "Alata"" [code: bad-notice-format]
* 🔥 **FAIL** Name Table entry: Copyright notices should match a pattern similar to: "Copyright 2019 The Familyname Project Authors (git url)"
But instead we have got:
"Copyright (c) 2011-2018, Sorkin Type Co (www.sorkintype.com) with Reserved Font Name "Alata"" [code: bad-notice-format]
...
* 🔥 **FAIL** OS/2.usWinDescent value 570 is too large. It should be less than double the yMin. Current absolute yMin value is 274 [code: descent]
...
* ⚠ **WARN** Name table entry ("Copyright (c) 2011-2018, Sorkin Type Co (www.sorkintype.com) with Reserved Font Name "Alata"") contains "Reserved Font Name". This is an error except in a few specific rare cases.
* ⚠ **WARN** Name table entry ("Copyright (c) 2011-2018, Sorkin Type Co (www.sorkintype.com) with Reserved Font Name "Alata"") contains "Reserved Font Name". This is an error except in a few specific rare cases.
